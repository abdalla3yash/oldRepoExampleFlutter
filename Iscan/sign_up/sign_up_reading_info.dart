...
class ReadingInfo extends StatefulWidget {
  static const String routeName = "/readinginfo";
          ...
          child: Column(children: <Widget>[
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Text(DevRead.reading_info_subtitle,
                    style: TextStyle(
                      fontSize: 17.0,
                    )),
              ),
            ...
            RoundedInputField(
              hintText: DevRead.reading_info_Sbtn,
            ),
            SizedBox(
              height: size.height * 0.025,
            ),
